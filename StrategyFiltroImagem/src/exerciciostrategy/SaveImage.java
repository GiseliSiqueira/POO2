...
public class SaveImage extends Component implements ActionListener {
    ...
    public void filterImage() {
        ...
        //Instancia a classe que aplica os filtros
        FiltroImagem filtroImagem = null;
        
        switch (opIndex) {
 
        case 0: /* original */
                //filtroImagem = new FiltroImagem(new Original(bi, biFiltered));
                //filtroImagem.aplicarFiltroImagem();
                biFiltered = bi;
                return; 
        case 1:  /* low pass filter */
            filtroImagem = new FiltroImagem(new LowPassFilter(op));
            break;
        case 2:  /* sharpen */
            filtroImagem = new FiltroImagem(new Sharpen(op));
            break;
        case 3 : /* lookup */
            filtroImagem = new FiltroImagem(new Lookup(op));
            break;
        }
        ...
        op = filtroImagem.aplicarFiltroImagem();
