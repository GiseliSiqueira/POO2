...
public class MainComPadrao {
    public static void main(String[] args) {
        ...
        for(int i=0; i< 200000; i++){             
            ...
            FlyweightStatusItem flystatus = new FlyweightStatusItem();
                
            ItemPedido item1 = new ItemPedido();
            item1.setDescricao("lapis de cor modelo xyz");
            item1.setNome("lapis");
            item1.setEstatus(flystatus.get(StatusItem.Estado.CARRINHO));
                
            ItemPedido item2 = new ItemPedido();
            item2.setDescricao("caneta cor azul");
            item2.setNome("caneta");                                    
            item2.setEstatus(flystatus.get(StatusItem.Estado.CARRINHO));
                
            ItemPedido item3 = new ItemPedido();
            item3.setDescricao("caneta cor vermelha");
            item3.setNome("caneta");                        
            item3.setEstatus(flystatus.get(StatusItem.Estado.CARRINHO));                       
